...
const TypingApp = () => {
  ...
  return <div className="mt-8 space-y-4 px-4">
    <h2 className="text-3xl font-samibold mb-5">Typing Speed Tester</h2> 
    ...
    <div className="flex gap-5">
      <Button color="blue" onClick={handleSubmit}  disabled={isSubmitted}>Submit</Button>
